...
void m_Otcep::update_descr()
{
    ...
    if (b_new){
        ...
        FSTATE_LEN =        stored_Descr.U_len  ;
        FSTATE_SL_VAGON_CNT=stored_Descr.vagon  ;
        FSTATE_V_OUT_1=     stored_Descr.V_out==65535 ? _undefV_:  stored_Descr.V_out/10.  ;
        FSTATE_V_IN_2=      stored_Descr.V_in2==65535 ? _undefV_:stored_Descr.V_in2/10.  ;
        FSTATE_V_OUT_2=     stored_Descr.V_out2==65535 ? _undefV_:stored_Descr.V_out2/10. ;
        FSTATE_V_IN_3=      stored_Descr.V_in3==65535 ? _undefV_:stored_Descr.V_in3/10.  ;
        FSTATE_V_OUT_3=     stored_Descr.V_out3==65535 ? _undefV_:stored_Descr.V_out3/10. ;
        ...
        FSTATE_V_IN_1=      stored_Descr.V_in==65535 ? _undefV_:stored_Descr.V_in/10.   ; // Cкорость входа 1 ТП
...
void m_Otcep::updateStates_0()
{
    ...
    if ((RCS!=descr_RCS)||(RCF!=descr_RCF)) {
        ...
        if ((RCF!=nullptr)&&( RCF->metaObject()->className()==qPrintable("m_RC_Gor_ZKR"))) setSTATE_ZKR_PROGRESS(true); else setSTATE_ZKR_PROGRESS(false);
        doStateChanged();
